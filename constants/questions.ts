...
export const QUESTIONS: QuestionItem[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { text: "\"오느라 고생했어.\" 부드럽게 미소 지으며 자연스럽게 짐을 들어준다.", scores: { potato: 1 } },
  ...
  },
  {
    ...
    options: [
      ...
      { text: "\"뭐 좋아해? 네가 먹고 싶은 거 두 개 시키고 내가 하나 더 고를게.\"", scores: { potato: 1, cheese: 1 } },
    ],
  },
  {
    id: 5,
    ...
    options: [
      ...
      { text: "\"내 눈엔 여전히 예쁜데? 얼른 당 충전하러 가자!\" 능글맞게 기분을 풀어준다.", scores: { salsa: 1 } },
  ...
  },
  {
    ...
    options: [
      ...
      { text: "\"...일단 밖에 나가서 좀 걷자.\" 말없이 시간을 두고 감정을 식히려 한다.", scores: { era: 1 } },
    ],
  },
  {
    id: 9,
  ...
  },
  {
    ...
    options: [
      ...
      { text: "\"우와 고마워! 잘 쓸게!\" 리액션은 크게 하지만 속으로는 활용도를 생각하는 눈치.", scores: { salsa: 1, ehem: 1 } },
...
export const QUESTIONS_GIRLFRIEND: QuestionItem[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { text: "\"뭐야~ 맛있는 거 사줘야 돼!\" 장난스럽게 투정 부리며 자연스럽게 넘어간다.", scores: { salsa: 1 } },
  ...
  },
  {
    ...
    options: [
      ...
      { text: "\"자긴 잘할 수 있어! 기운 내!\" 밝은 에너지로 내 텐션을 끌어올려 주려 노력한다.", scores: { salsa: 1 } },
    ],
  },
  {
    id: 5,
    ...
    options: [
      ...
      { text: "\"와, 지금 배경 너무 예쁘다! 자기랑 같이 셀카 찍자!\" 나랑 같이 찍는 걸 더 좋아한다.", scores: { salsa: 1 } },
  ...
  },
  {
    ...
    options: [
      ...
      { text: "\"자기야, 나 저거 사주면 안 돼? (반짝)\" 대놓고 애교 섞인 힌트를 준다.", scores: { egen: 1 } },
  ...
  },
  {
    ...
    options: [
      ...
      { text: "틈틈이 내 안부를 물으며 \"자기 생각나서 연락했어\"라고 다정하게 말한다.", scores: { potato: 1 } },
  ...
  },
  {
    ...
    options: [
      ...
      { text: "\"아쉽다.. 조금만 더 같이 있으면 안 돼?\" 대문 앞에서 한참을 서성인다.", scores: { sweet_potato: 1 } },
  ...
  },
  {
    ...
    options: [
      { text: "\"오늘 하루도 수고했어, 사랑해!\" 꿀 떨어지는 애정 표현으로 마무리한다.", scores: { sweet_potato: 1 } },
